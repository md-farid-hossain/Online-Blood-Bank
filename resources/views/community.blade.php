    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
      ...
      <div class="container box">
       ...
       <div class="panel panel-default">
        ...
        <div class="card-header"><i class="fas fa-search"></i> Search Blood Bank | <a href="{{url('create')}}"><i class="fab fa-odnoklassniki"></i> Blood Donation Rule</a></div>
        ...
        <div class="panel-body">
         ...
         <div class="table-responsive">
          <h3 align="center">Total Blood Bank : <span id="total_records"></span></h3>

                    ...
                    <div class="card-body">
                                ...
                                <ul class="nav nav-pills">
                                    <li role="presentation">
                                        <a href='{{url("/like/{$post->id}")}}'>
                                            <span id="ved" class="fa fa-thumbs-up">Like</span>
                                        </a>
                                    </li>
                                    <li role="presentation">
                                        <a href='{{url("/dislike/{$post->id}")}}'>
                                            <span id="ved" class="fa fa-thumbs-down">Dislike</span>
                                        </a>
                                    </li>
                                    <li role="presentation">
                                        <a href='{{url("/comment/{$post->id}")}}'>
                                            <span id="ved" class="fa fa-comment-o"><i class="far fa-comment"></i> Comment</span>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        {{csrf_field()}}
                            <div class="form=group">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success btn-lg btn-block"><i class="far fa-comment"></i> Post Comment</button>
                                </div>
                        ...
                        @if(count($comments)>0)
                            @foreach($comments->all() as $comment)
                                <p>{{ $comment->comment }}</p>  
                                <p>Commented By : {{ $comment->last_name }}</p>
                            @endforeach
                        @else
                            <p>No Comment Yet!</p>
